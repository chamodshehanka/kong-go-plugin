...
SERVICE_URL="http://your-backend-service-url"
ROUTE_PATH="/backend"
PLUGIN_NAME="hello_world"
CONSUMER_USERNAME="tsel-consumer"
...
curl -i -X POST $KONG_ADMIN_URL/consumers \dcab3be9-bee0-45d6-82a2-1429fd23ac9a
  --data "username=$CONSUMER_USERNAME"

# Get the consumer's UUID
CONSUMER_ID=$(curl -s $KONG_ADMIN_URL/consumers/$CONSUMER_USERNAME | jq -r .id)

# Add the custom plugin to the service
echo "Adding plugin..."
